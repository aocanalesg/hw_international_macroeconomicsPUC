...
crit = 1e-8;                      
nit  = 1000;                      
target=[3.0406; 0.9960; 5.6157; 0.4135];
[fhat,x_opt_hat] = csminwel(@prob5moment_objective,x_start,H0,[],crit,nit,target,oo_, M_,options_); 
set_param_value('rho',x_opt_hat(1)); 
...
save([M_.dname filesep 'Output' filesep 'prob5edeir_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'prob5edeir_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'prob5edeir_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'prob5edeir_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'prob5edeir_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'prob5edeir_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'prob5edeir_results.mat'], 'oo_recursive_', '-append');
end
if ~isempty(lastwarn)
