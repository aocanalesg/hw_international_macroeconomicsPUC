...
M_.params(strmatch('sigmae',M_.param_names,'exact')) = xopt(1);  % sigmae
M_.params(strmatch('rho',M_.param_names,'exact'))    = xopt(2);  %rho
...
%Colecting moments of the model 
    model_moments(1,1) = sqrt(oo_.var(1,1));      %we get sd of y in oo_.var
