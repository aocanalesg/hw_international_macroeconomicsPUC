...
g1(3,15)=1;
g1(4,1)=(-(y(13)*params(12)*params(4)/y(5)));
g1(4,5)=(-(y(13)*params(12)*(-(params(4)*y(1)))/(y(5)*y(5))));
g1(4,13)=1-params(12)*(1-params(2)+params(4)*y(1)/y(5));
g1(5,2)=(-T(7));
g1(5,4)=(-T(8));
g1(5,14)=1;
g1(6,2)=(-(T(3)*T(7)));
...
g1(14,11)=(-(1/y(11)/y(1)));
g1(14,12)=1/y(12);
g1(15,8)=1/y(8)-(params(9)*1/y(8)+params(10)*1/y(8));
g1(16,8)=(-1);
g1(16,16)=1;
if ~isreal(g1)
