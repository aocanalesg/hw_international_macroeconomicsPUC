...
stoch_simul(order=1,loglinear,contemporaneous_correlation);%que me calcule la correlacion contemporanea, y esto es lo que voy a matchear voy a machear el ciclo del consumo con el ciclo del producto
%%%%%%%%%%%%


x_start=[sigmae rho]; %use calibration as starting point, pongo los parametros que quiero calibrar, el orden no es importante
...
target=[0.0474; 0.81];%los parametros que yo quiero machear OJO AqUI
